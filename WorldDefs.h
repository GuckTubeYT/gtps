		...
		case ENET_EVENT_TYPE_RECEIVE:
		{
			...
			case 2:
			{
				...
				if(pStr.substr(0, 17) == "action|enter_game" && !((PlayerInfo*)(event.peer->data))->isIn)
				{
					...
					// growmoji
					GamePacket p2ssw = packetEnd(appendString(appendInt(appendString(createPacket(), "OnEmoticonDataChanged"), 201560520), "(wl)|a|1&(yes)|A|1&(no)|a|1&(love)|A|1&(oops)|a|1&(shy)|C|1&(wink)|c|1&(tongue)|C|1&(agree)|c|1&(sleep)|C|1&(punch)|c|1&(music)|C|1&(build)|c|1&(megaphone)|D|1&(sigh)|d|1&(mad)|Ð|1&(wow)|d|1&(dance)|E|1&(see-no-evil)|e|1&(bheart)|E|1&(heart)|e|1&(grow)|E|1&(gems)|e|1&(kiss)|E|1&(gtoken)|e|1&(lol)|E|1&(smile)|A|1&(cool)|G|1&(cry)|g|1&(vend)|G|1&(bunny)|e|1&(cactus)|g|1&(pine)|H|1&(peace)|g|1&(terror)|g|1&(troll)|G|1&(evil)|G|1&(fireworks)|H|1&(football)|h|1&(alien)|h|1&(party)|I|1&(pizza)|i|1&(clap)|I|1&(song)|i|1&(ghost)|I|1&(nuke)|i|1&(halo)|I|1&(turkey)|i|1&(gift)|I|1&(cake)|i|1&(heartarrow)|?|1&(lucky)|?|1&(shamrock)|J|1&(grin)|j|1&(ill)|K|1&"));
